...
int main(int argc, char *argv[]) {
  ...
  if (argc != 5) {
    ...
    printf(
        "Example:/project/tools1/bin/procctl 10 /project/idc1/bin/obtmindtodb "
        "/idcdata/surfdata \"127.0.0.1,root,mysqlpwd,mysql,3306\" utf8 "
        "/log/idc/obtmindtodb.log\n\n");

    printf("本程序用于把全国站点分钟观测数据保存到数据库的T_"
